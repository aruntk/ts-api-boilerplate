...
var getChoices = function(config) {
  var length = longest(Object.keys(config)).length + 1;
  var choices = map(config, function (entry, key) {
...
module.exports = function (options) {
  ...
  var typeChoices = getChoices(types);
  var scopeChoices = getChoices(scopes);
